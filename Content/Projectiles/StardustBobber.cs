...
namespace luckeitems.Content.Projectiles
{
	public class StardustBobber : ModProjectile
	{
		public static readonly Color[] PossibleLineColors = new Color[] {
			new Color(0, 106, 185), // A gold color
		};
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Stardust Bobber");
		}
