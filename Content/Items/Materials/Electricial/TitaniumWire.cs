...
{
	public class TitaniumWire : ModItem
	{
		public override void SetStaticDefaults() {
            DisplayName.SetDefault("Titanium Wire");
            Tooltip.SetDefault("Titanium Wire\n"
                             + "'FUNNY TEXT'\n");
		...
		public override void AddRecipes() {
            ...
            recipe.AddRecipeGroup("luckeitems:TitaniumBarGroup", 3);
