...
namespace luckeitems.Content.Items.Materials.Electricial
{
	public class AIChip : ModItem
	{
		public override void SetStaticDefaults() {
            ...
            Tooltip.SetDefault("Strange, combining the souls of the three mechanical beasts with a capacitor and binding it with silicon has resulted in a supernatural AI.\n"
                             + "'FUNNY TEXT'\n");
		...
		public override void AddRecipes() {
            ...
            recipe.AddIngredient<Capacitor>(1);
